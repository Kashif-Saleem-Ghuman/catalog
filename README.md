...
**[Catalog]** is a console app that helps you to keep a record of different types of things you own: books, music albums, movies, and games.
...
- **[Creates a record of books that I own]**
- **[Creates a record of music albums that I own]**
- **[Creates a record of games that I own]**
...
```sh
  cd your-folder
  git clone https://github.com/Kashif-Saleem-Ghuman/catalog.git
```
...
Feel free to check the [issues page](https://github.com/Kashif-Saleem-Ghuman/catalog/issues).
